...
class ForkAttentionMetadataBuilder(FlashAttentionMetadataBuilder):
    # Dynamic forest topology is not full-CUDA-graph safe yet. Piecewise graphs
    # still execute attention eagerly and can use ForkAttention.
    ...
    def _build_fork_kwargs(
        ...
        if not self._can_build_fork(metadata, num_reqs) or cpu_metadata is None:
            return {}
